...
bool GameManager::onInit() { 
	...
	else
	{
		...
		else
		{
			...
			gFantasmaTexture[2] = loadTexture("Resources/Fantasma.bmp");
			if (gFantasmaTexture[2] == NULL)
			{
				cout << "Fallo en la carga de la textura fantasma 1" << endl;
				success = false;
			}
			gFantasmaTexture[3] = loadTexture("Resources/Fantasma.bmp");
			if (gFantasmaTexture[3] == NULL)
			{
				cout << "Fallo en la carga de la textura fantasma 1" << endl;
				success = false;
			}
			gFantasmaTexture[4] = loadTexture("Resources/Fantasma.bmp");
			...
			gFantasmaTexture[5] = loadTexture("Resources/Fantasma.bmp");
			if (gFantasmaTexture[5] == NULL)
			{
				cout << "Fallo en la carga de la textura fantasma 1" << endl;
				success = false;
			}
